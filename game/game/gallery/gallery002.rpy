...
screen gallery_002:
    ...
    imagemap:
        ...
        hotspot (461, 943, 95, 95) action ShowMenu("gallery_001")
        ...
        hotspot (1371, 943, 95, 95) action ShowMenu("gallery_003")
    ...
    grid 3 2:
        ...
        add g.make_button("a1","gallery/pic/cover/2_1.png", locked = "gallery/pic/cover/locked.png")
        add g.make_button("a2","gallery/pic/cover/2_2.png", locked = "gallery/pic/cover/locked.png")
        add g.make_button("a3","gallery/pic/cover/2_3.png", locked = "gallery/pic/cover/locked.png")

        add g.make_button("a4","gallery/pic/cover/2_4.png", locked = "gallery/pic/cover/locked.png")
        add g.make_button("a5","gallery/pic/cover/2_5.png", locked = "gallery/pic/cover/locked.png")
        add g.make_button("a6","gallery/pic/cover/2_6.png", locked = "gallery/pic/cover/locked.png")
